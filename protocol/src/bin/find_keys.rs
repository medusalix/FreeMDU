...
const READ_KEYS: [u16; 9] = [
    0x43ea, 0xb4ee, 0x1234, 0x2b67, 0x04d2, 0x2e69, 0x15a8, 0xbde7, 0x8542,
];
const FULL_ACCESS_KEYS: [u16; 9] = [
    0x1f02, 0x4e83, 0x5678, 0x8235, 0x162e, 0x3e3b, 0x703d, 0x902f, 0x6567,
];
