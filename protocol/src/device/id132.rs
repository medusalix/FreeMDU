...
///
/// println!("Program selection: {}", machine.query_program_selector().await?);
...
impl<P: Read + Write> WashingMachine<P> {
    ...
    pub async fn query_tachometer_speed(&mut self) -> Result<(u16, u16), P::Error> {
        ...
        // Speed calculations for the motor are performed in a subroutine at 0xc747.
